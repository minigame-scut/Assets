...
public class SManager : MonoBehaviour
{
    ...
    private void responseForSignalBROKESPEEDDOOR(Transform transform)
    {
        ...
        {
            audioManager.GetComponent<AudioManager>().PlaySound("Music/Sounds/Sou/BounceDoor");
        }
    }
    ...
    private void responseForSignalGDOOR()
    {
        ...
        if (audioManager != null)
        {
            audioManager.GetComponent<AudioManager>().PlaySound("Music/Sounds/Sou/GravityDoor");
        }
    }
    ...
    private void responseForTRANSDOOR(Vector3 newPosition, string curTag)
    {
        ...
        if (audioManager != null)
        {
            audioManager.GetComponent<AudioManager>().PlaySound("Music/Sounds/Sou/TransferDoor");
        }
    }
    private void responseForUPSPEEDDOOR()
    {
        ...
        if (audioManager != null)
        {
            audioManager.GetComponent<AudioManager>().PlaySound("Music/Sounds/Sou/UpSpeedDoor");
        }
    }
    ...
    private void responseForWALK()
    {
        ...
        if (audioManager != null)
        {
            audioManager.GetComponent<AudioManager>().PlaySound("Music/Sounds/Sou/Walk");
        }
    }
    ...
    private void responseForDEATH()
    {
        ...
        if (audioManager != null)
        {
            audioManager.GetComponent<AudioManager>().PlaySound("Music/Sounds/Sou/Death");
        }
    ...
    private void responseForJUMP()
    {
        ...
        if (audioManager != null)
        {
            audioManager.GetComponent<AudioManager>().PlaySound("Music/Sounds/Sou/Jump2");
        }
    }
